...
import undikshaImg from '../img/undiksha.png'
import dagoImg from '../img/dago.png'
...
const HeroSection = () => {
    return (
        <div className="grid grid-cols-1 gap-2 px-2 py-24 lg:grid-cols-3 md:grid-cols-2 lg:gap-4 auto-fit">
            ...
            <div className="mt-0 ml-6 lg:ml-24 lg:mt-36 mb-12">
                <h1 className="text-4xl font-bold lg:text-5xl">Collaboration</h1>
                <div className="flex p-4 pl-0 lg:pl-12">
